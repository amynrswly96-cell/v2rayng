...
class MainRecyclerAdapter(
    ...
    override fun onBindViewHolder(holder: BaseViewHolder, position: Int) {
        if (holder is MainViewHolder) {
            ...
            //layout
            // Share and "more" (copy/QR) entry points are intentionally hidden from the
            // server list UI. Underlying onShare/copy logic in the adapter listener is
            // untouched; only these two icons are no longer shown to the user.
